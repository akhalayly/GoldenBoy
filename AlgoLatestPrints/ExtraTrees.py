...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        for minSplit in [2, 5, 10, 20, 30]:
            ...
            for numOfEsti in [1, 5, 10, 20, 40, 70, 100, 150]:
                for train_index, test_index in splits:
                    ...
                    clf = ExtraTreesClassifier(criterion="gini", min_samples_split=minSplit,
        ...
        plt.title('Accuracy Rate Extra Trees ' + file)
        plt.xlabel('Number of Estimators')
        plt.ylabel('Mean Accuracy')
        plt.legend([str(i) for i in last_results.keys()])
        plt.savefig("Results/ExtraTrees/Graph_" + file + ".png")
        plt.show()
        ...
        table = ax.table(cellText=df.values, rowLabels=[1, 5, 10, 20, 40, 70, 100, 150], colLabels=df.columns,
                         colWidths=[0.3, 0.3, 0.3, 0.3, 0.3], loc='bottom', cellLoc='center', rowColours=['r','r','r','r','r','r','r','r'],
        ...
        fig.tight_layout()
        fig.savefig("Results/ExtraTrees/" + file + ".png")
        plt.show()
